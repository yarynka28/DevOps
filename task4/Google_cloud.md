...
##### Public IP of Wordpress - *http://34.79.126.251/*
![image](https://user-images.githubusercontent.com/104198926/209433889-debf2464-6a70-4cd6-a689-bc1349324ee8.png)
##### Data for test login:
URL: http://34.79.126.251/wp-login.php
```
Login name: user
Password: 6dGO3h)7wg%6t0kfR2mutToU
```
##### Useful site about WordPress installation:
https://spacelift.io/blog/getting-started-with-terraform-on-google-cloud-platform-gcp

##### Commands used for installation [init.sh](init.sh):
```bash
apt update
